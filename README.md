...
* To know which subcommand has been called by the command line you need to access
the `method` attribute of the object returned by `parser.parse_args()` it will
